...
{
    /// <summary>
    /// A generic edge that has a distance and a set of tags (or attributes).
    /// </summary>
    public struct GenericEdge : IGraphEdgeData
    {
        /// <summary>
        ...
        {
            if (other is GenericEdge)
            { // ok, type is the same.
                var otherLive = (GenericEdge)other;
