...
namespace OsmSharp.Test.Unittests.Routing
{
        ...
        where TEdgeData : IEdge
    {
        ...
        /// <returns></returns>
        public abstract Router BuildRouter(BasicRouterDataSource<TEdgeData> data,
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        public abstract IBasicRouter<TEdgeData> BuildBasicRouter(BasicRouterDataSource<TEdgeData> data);
        ...
        /// <returns></returns>
        public abstract BasicRouterDataSource<TEdgeData> BuildData(IOsmRoutingInterpreter interpreter, 
        ...
        {
            var interpreter = new OsmRoutingInterpreter();
            BasicRouterDataSource<TEdgeData> data = this.BuildData(interpreter, "OsmSharp.Test.Unittests.test_network.osm");
